...
public class Escenario1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //coneccion a preproduccion
        driver.get("https://creditodigitalpruebas.crezcamos.com:9341/aliado/GAHm2HmWKxfYsY5PSjG5hw%3D%3D");
        ...
        driver.findElement(By.xpath("//*[@id=\"1990\"]")).click();
        driver.findElement(By.xpath("/html/body/p-dynamicdialog/div/div/div/app-componente-modal-fechas/div/div/div[2]/div[3]/div/div/div[3]")).click();
        ...
        cuantosmeses.sendKeys("580");
        Thread.sleep(1000);

        WebElement material = driver.findElement(By.xpath("//*[@id=\"pr_id_16_list\"]/p-dropdownitem[1]/li"));
        JavascriptExecutor ma = (JavascriptExecutor) driver;
        ma.executeScript("arguments[0].click()",material);
        driver.findElement(By.xpath("//*[@id=\"pr_id_16_list\"]/p-dropdownitem[1]/li")).click();
        Thread.sleep(1000);
        ...
        WebElement referencia = driver.findElement(By.xpath("//*[@id=\"REFPLA\"]"));
        referencia.sendKeys("Carlos perez");
        Thread.sleep(1000);

        WebElement ps11 = driver.findElement(By.xpath("/html/body/app-root/app-flujo-digital/app-chat/div/div/div/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div"));
        JavascriptExecutor v1 = (JavascriptExecutor) driver;
        v1.executeScript("arguments[0].click()",ps11);
        Thread.sleep(5000);
